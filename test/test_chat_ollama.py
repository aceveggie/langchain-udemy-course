...
def implement_llama_4_model():
    ...
    """
    # TODO: Your implementation here
    llm = ChatGroq(model="llama-4-8b-instant", temperature=0.0, max_retries=2)
    return llm
...
def implement_compare_models(prompt):
    ...
    """
    # TODO: Your implementation here
    llama3_70b = implement_llama_3_3_model()
    llama4_8b = implement_llama_4_model()
    llama3_70b_response = implement_query_model(llama3_70b, prompt)
    llama4_8b_response = implement_query_model(llama4_8b, prompt)
    return {'llama3_content': llama3_70b_response, 'llama4_content': llama4_8b_response}
